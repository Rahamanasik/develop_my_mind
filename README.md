![https://github.com/rahamanasik](https://img.shields.io/badge/Github-Programming-blue?style=plastic&logo=github)
![https://github.com/Rahamanasik/develop_my_mind.git](https://img.shields.io/badge/Python-Programming_Language-orange)
![https://github.com/Rahamanasik/develop_my_mind.git](https://img.shields.io/badge/Py-Basic-blue)

Develop My Mind
===========
I am a Programmer. আমি প্রোগ্রামিং শিখতে চায় কারন Programm এর মাধ্যমে Advance Level সম্পর্কে জানা যাবে। Program শিখার মাধ্যমে আমি google বা facebook বা বড় বড় IT Company গুলোর মধ্যে Job Apply করতে পারব। Program শিখার মাধ্যমে আমার দক্ষতা সম্পর্কে জানতে হবে। কারন বর্তমান বিশ্ব IT উপর নির্ভরশীল । সেজন্য Program শিখা অত্যন্ত গুরুত্বপূর্ণ।
